...
urlpatterns = [
    ...
    path('platform/platform-patrol/', views.platform_self_patrol, name='platform_self_patrol'),
    path('platform/platform-patrol/submit/', views.platform_self_patrol_submit, name='platform_self_patrol_submit'),
